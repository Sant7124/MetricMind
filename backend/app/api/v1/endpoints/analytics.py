...
async def get_dashboard_kpis():
    ...
    try:
        adapter = get_warehouse_adapter("postgres")
        revenue = await adapter.execute_query("SELECT SUM(total_amount) as revenue FROM orders")
        orders = await adapter.execute_query("SELECT COUNT(id) as count FROM orders")
        customers = await adapter.execute_query("SELECT COUNT(DISTINCT customer_id) as count FROM orders")
